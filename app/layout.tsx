...
export const metadata: Metadata = {
  ...
  keywords:["Adarsh Nagar","Portfolio","Adarsh Nagar Github","Adarsh Nagar St. Xavier's College Student","Adarsh Nagar Web Developer","Adarsh Nagar full stack developer","Developer","Next.js","React","fullstack"],
  openGraph:{
    title: 'Adarsh Nagar - Portfolio',
