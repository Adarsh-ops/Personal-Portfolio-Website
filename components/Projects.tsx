...
export default function Projects() {
    const projects = [
        ...
        { title:'Collabidraw- Collaborative Drawing App', description:'Developed Collabidraw, a real-time collaborative drawing application inspired by Excalidraw, enabling multiple users to draw, write, and edit on shared canvases with features like shapes, pencil, lines, arrows, and WebSocket synchronization. Built as a monorepo with Turborepo, using Next.js and React for the frontend, Express.js and Node.js for the backend, PostgreSQL with Prisma for the database.',image:Collabidraw, github:'https://github.com/Adarsh-ops/Collabidraw', techstack:'Next.js, Tailwind CSS, Express.js, Node.js, TypeScript, Zod, Websockets, PostgreSQL and Prisma ORM'},
